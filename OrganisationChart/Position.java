...
public class Position {
    ...
    public void addToTeam(Position newMemb){
        ...
        /*# YOUR CODE HERE */
        newMemb.manager = this; //Sets the manager of the newMemb
        this.team.add(newMemb); // Adds the newMemb to the managers team
    ...
    public void removeFromTeam(Position teamMemb){
        /*# YOUR CODE HERE */
        teamMemb.manager = null; // Set the teamMemb manager to null
        team.remove(teamMemb); // Removes the teamMemb from the Manager team
