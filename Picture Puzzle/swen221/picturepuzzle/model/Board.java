...
public class Board {
	...
	String originalState; // Board before it is shuffled
	...
	public Board(int[] image, int width, int dimension) {
		...
		this.originalState = toString(); //Save the board before it's shuffled
	}
	...
	public boolean isFinished() {
		if(toString().equals(originalState)) return true; // Checks if the current state matches the state before shuffle.
		return false;
	}
