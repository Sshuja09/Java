...
public abstract class AbstractCardGame implements CardGame {
	...
	public AbstractCardGame(AbstractCardGame other) {
		this.players.putAll(other.players);
		this.tricks.putAll(other.tricks);
		this.scores.putAll(other.scores);
		this.trumps = other.trumps;
		this.currentTrick = other.currentTrick;
    }
