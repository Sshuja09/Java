...
public class MineSweeper {
    ...
    public void tryExpose(int row, int col){
        /*# YOUR CODE HERE */
        // If square is exposed or marked
    ...
    public void exposeSquareAt(int row, int col){
        ...
        exposeSquareAt(row - 1, col - 1); // top-left corner
        exposeSquareAt(row - 1, col - 0);
        exposeSquareAt(row - 1, col + 1);

        exposeSquareAt(row - 0, col - 1); // Middle
        exposeSquareAt(row - 0, col + 1);

        exposeSquareAt(row + 1, col - 1); // Top right corner
        exposeSquareAt(row + 1, col - 0);
        exposeSquareAt(row + 1, col + 1);
    }
