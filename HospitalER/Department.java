...
public class Department{
    ...
    Set<Patient>  treatmentRoom;
    Queue<Patient> waitingRoom;

    /*# YOUR CODE HERE */
    public Department(String name, int maxPatients, boolean usePriorityQueue) {
        this.name = name;
        this.maxPatients = maxPatients;
        if(usePriorityQueue){this.waitingRoom = new PriorityQueue<Patient>();}
        else{this.waitingRoom = new ArrayDeque<Patient>();}
